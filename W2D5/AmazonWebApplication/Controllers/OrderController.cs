...
namespace Task1.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public async Task<ActionResult<SumOfOrdersByCountry>> SumOfOrdersCostByCountryName(string name)
        {
            try
            {
        ...
        //GetAllOrderByCountryName2
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [Produces("application/json", Type = typeof(IEnumerable<AmazonOrder>))]
        [Route("GetAllOrderByCountryName2")]
        public async Task<ActionResult<List<AmazonOrder>>> GetAllOrdersByCountryName2(List<string> AC)
        {
            try
            {
                var resp = await _amazonBusiness.GetAllOrderByCountry2(AC);
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [Produces("application/json", Type = typeof(IEnumerable<AmazonOrder>))]
        [Route("SumOfOrdersByCountry")]
        public async Task<ActionResult<SumOfOrdersByCountry>> SumOfOrdersByCountry()
        {
            try
            {

                var resp = await _amazonBusiness.SumOfOrdersByCountry();
